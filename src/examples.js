...
EXAMPLE.Mercury = new KEPLER.AstroBody(3.302e23);
EXAMPLE.Mercury.orbit = new KEPLER.Orbit(
    EXAMPLE.Sol                         //Primary
...
EXAMPLE.Venus = new KEPLER.AstroBody(4.8685e24);
EXAMPLE.Venus.orbit = new KEPLER.Orbit(
    EXAMPLE.Sol                         //Primary
...
EXAMPLE.Mars = new KEPLER.AstroBody(6.4185e23);
EXAMPLE.Mars.orbit = new KEPLER.Orbit(
    EXAMPLE.Sol                         //Primary
...
EXAMPLE.Phobos = new KEPLER.AstroBody(1.08e20);
EXAMPLE.Phobos.orbit = new KEPLER.Orbit(
...
EXAMPLE.Deimos = new KEPLER.AstroBody(1.80e20);
EXAMPLE.Deimos.orbit = new KEPLER.Orbit(
    EXAMPLE.Mars                        //Primary
